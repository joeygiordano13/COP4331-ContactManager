...
class ContactsApi
{
    ...
    /**
     * Operation toggleContacts
     *
     * Sort contacts by name or by date created.
     *
     * @param  \Swagger\Client\Model\ToggleContacts $toggle_items Sort the contacts array. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function toggleContacts($toggle_items = null)
    {
        $this->toggleContactsWithHttpInfo($toggle_items);
    }

    /**
     * Operation toggleContactsWithHttpInfo
     *
     * Sort contacts by name or by date created.
     *
     * @param  \Swagger\Client\Model\ToggleContacts $toggle_items Sort the contacts array. (optional)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function toggleContactsWithHttpInfo($toggle_items = null)
    {
        $returnType = '';
        $request = $this->toggleContactsRequest($toggle_items);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function toggleContactsAsync($toggle_items = null)
    {
        return $this->toggleContactsAsyncWithHttpInfo($toggle_items)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation toggleContactsAsyncWithHttpInfo
     *
     * Sort contacts by name or by date created.
     *
     * @param  \Swagger\Client\Model\ToggleContacts $toggle_items Sort the contacts array. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function toggleContactsAsyncWithHttpInfo($toggle_items = null)
    {
        $returnType = '';
        $request = $this->toggleContactsRequest($toggle_items);
    ...
    /**
     * Create request for operation 'toggleContacts'
     *
     * @param  \Swagger\Client\Model\ToggleContacts $toggle_items Sort the contacts array. (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function toggleContactsRequest($toggle_items = null)
    {

        $resourcePath = '/ToggleContacts.php';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($toggle_items)) {
            $_tempBody = $toggle_items;
        }
